        ...
        <main v-else class="page-roulette">
            ...
            <section class="levels-container">
                <div style="text-align: center;" class="levels" v-if="selected === 0">
                    ...
                    <p>
                        This page details everything you need to know about the list, from submitting your own challenges to recording and submitting records. Please read through these before trying to submit a challenge or record because, chances are, it will get denied due to some easily fixable reason detailed here. 
                    </p>
                </div>
                <div class="levels" v-if="selected === 1">
                    ...
                    <p>
                        You must have Cheat Indicator enabled in your completion, including the <a href="./assets/exmaple screenshots/cheat indi.png" target="_blank"><u>Show on Endscreen setting.</u></a> Unmodded versions of GD are exempt from this.
                    </p>
                    <p>
                        If you do not have any mods installed (including MegaHack, Geode), please enable the <a href="./assets/exmaple screenshots/info label.png" target="_blank"><u>Show Info Label setting.</u></a>
                    </p>
                    <p>
                ...
                <div class="levels" v-else-if="selected === 2">
                    ...
                    <p>
                        No Spam Based or Straight-Fly challenges. (Ex. <a href="https://youtu.be/Nwy9t3gMYQ4" target="_blank">Final Flight</a>, <a href="https://www.youtube.com/watch?v=U5OOany-jCs" target="_blank">Garbanzo,</a> etc.)
                    </p>
                    <p>
                ...
                <div class="levels" v-else-if="selected === 4">
                    ...
                    <p>
                        The Reliable system (almost entirely copied from <a href="https://laylist.pages.dev" target="_blank"><u>The Layout List</u></a>) is how we decide whether a challenge meets all standards for the list. When levels are submitted, they are given to "Reliable" members to play and vote on whether the level is list worthy in its decoration, gameplay, and sync. A member is given reliable by being active and showing that they are trustworthy. Every month or so, the list team promotes and demotes people from the reliable system. Reliables also vote on the difficulty of a level, and give their opinion as to where on the list it should go. This entire process happens through our <a href="https://discord.gg/87QtEZv5kp" target="_blank">Discord Server</a>.
                    </p>
